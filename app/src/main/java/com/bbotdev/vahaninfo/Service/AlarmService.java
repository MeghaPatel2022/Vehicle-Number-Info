package com.bbotdev.vahaninfo.Service;
...
import com.bbotdev.vahaninfo.activity.MainActivity;
...
public class AlarmService extends JobIntentService {
    ...
    public static final String ANDROID_CHANNEL_ID = "com.bbotdev.vahaninfo";
    /**
    ...
    private void sendNotification() {
        ...
        notificationBuilder = new NotificationCompat.Builder(getApplicationContext(), ANDROID_CHANNEL_ID)
                .setLargeIcon(BitmapFactory.decodeResource(getApplicationContext().getResources(), R.drawable.logo_512))
                .setSmallIcon(R.drawable.logo_512)
                .setContentTitle(getApplicationContext().getResources().getString(R.string.app_name))
                .setContentText("Petrol and Diesel Price updated")
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationChannel.setDescription("Petrol and Diesel Price updated");
