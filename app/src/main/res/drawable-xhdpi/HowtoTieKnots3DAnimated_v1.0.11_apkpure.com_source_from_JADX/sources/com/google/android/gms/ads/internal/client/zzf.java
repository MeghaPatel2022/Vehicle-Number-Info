...
public class zzf implements Creator<AdRequestParcel> {
    static void zza(AdRequestParcel adRequestParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 10, (Parcelable) adRequestParcel.zzsx, i, false);
        zzb.zza(parcel, 11, (Parcelable) adRequestParcel.zzsy, i, false);
        ...
        while (parcel.dataPosition() < zzaj) {
            ...
            switch (zza.zzbH(zzai)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    searchAdRequestParcel = (SearchAdRequestParcel) zza.zza(parcel, zzai, (Creator<T>) SearchAdRequestParcel.CREATOR);
                    break;
                case 11:
