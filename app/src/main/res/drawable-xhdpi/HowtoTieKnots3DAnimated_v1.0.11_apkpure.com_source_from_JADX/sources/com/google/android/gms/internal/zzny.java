...
public interface zzny extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzny {
        ...
        /* renamed from: com.google.android.gms.internal.zzny$zza$zza reason: collision with other inner class name */
        private static class C1449zza implements zzny {
            private IBinder zznI;

            C1449zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzny zzbT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzny)) ? new C1449zza(iBinder) : (zzny) queryLocalInterface;
        }
