...
public interface zzre extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzre {
        ...
        private static class C1469zza implements zzre {
            private IBinder zznI;

            C1469zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzre zzdT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzre)) ? new C1469zza(iBinder) : (zzre) queryLocalInterface;
        }
