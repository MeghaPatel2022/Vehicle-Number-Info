...
public class zzs {
    ...
    static class zza {
        ...
        private final List<C1473zza> zzal = new ArrayList();
        ...
        private static class C1473zza {
            public final String name;
            public final long time;
            public final long zzan;

            public C1473zza(String str, long j, long j2) {
                this.name = str;
                this.zzan = j;
                this.time = j2;
            }
        ...
        private long zzx() {
            ...
            return ((C1473zza) this.zzal.get(this.zzal.size() - 1)).time - ((C1473zza) this.zzal.get(0)).time;
        }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzal.add(new C1473zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            long zzx = zzx();
            if (zzx > 0) {
                long j = ((C1473zza) this.zzal.get(0)).time;
                zzs.zzb("(%-4d ms) %s", Long.valueOf(zzx), str);
                long j2 = j;
                for (C1473zza zza : this.zzal) {
                    long j3 = zza.time;
