...
public interface zzfl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfl {
        ...
        /* renamed from: com.google.android.gms.internal.zzfl$zza$zza reason: collision with other inner class name */
        private static class C1406zza implements zzfl {
            private IBinder zznI;

            C1406zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzfl zzN(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzfl)) ? new C1406zza(iBinder) : (zzfl) queryLocalInterface;
        }
