...
public final class zzq implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    public static final class zza extends ViewSwitcher {
        ...
        public void zzbR() {
            zzb.m20v("Disable position monitoring on adFrame.");
            if (this.zzqG != null) {
                this.zzqG.zzgE();
            }
        }
    ...
    public zzq(Context context2, AdSizeParcel adSizeParcel, String str, VersionInfoParcel versionInfoParcel) {
        this(context2, adSizeParcel, str, versionInfoParcel, null);
    }

    zzq(Context context2, AdSizeParcel adSizeParcel, String str, VersionInfoParcel versionInfoParcel, zzan zzan) {
        this.zzqx = null;
        this.zzqy = null;
        this.zzqz = 0;
        this.zzqA = false;
        ...
        if (adSizeParcel.zzsH || adSizeParcel.zzsJ) {
            ...
            this.zzqc = new zza(context2, this, this);
