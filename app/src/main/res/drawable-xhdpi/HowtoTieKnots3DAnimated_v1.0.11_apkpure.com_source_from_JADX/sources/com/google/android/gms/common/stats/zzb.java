...
public class zzb {
    ...
    private zzb() {
        ...
        String str2 = (String) zza.zzafF.get();
        this.zzafw = str2 == null ? Collections.EMPTY_LIST : Arrays.asList(str2.split(","));
        String str3 = (String) zza.zzafG.get();
        this.zzafx = str3 == null ? Collections.EMPTY_LIST : Arrays.asList(str3.split(","));
        String str4 = (String) zza.zzafH.get();
        this.zzafy = str4 == null ? Collections.EMPTY_LIST : Arrays.asList(str4.split(","));
    ...
    private boolean zzb(Context context, Intent intent) {
        ...
        if (component == null || (zzd.zzacF && "com.google.android.gms".equals(component.getPackageName()))) {
            return false;
        }
