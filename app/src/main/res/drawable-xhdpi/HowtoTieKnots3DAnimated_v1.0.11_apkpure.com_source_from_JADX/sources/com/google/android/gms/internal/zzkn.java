...
public interface zzkn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkn {
        ...
        /* renamed from: com.google.android.gms.internal.zzkn$zza$zza reason: collision with other inner class name */
        private static class C1423zza implements zzkn {
            private IBinder zznI;

            C1423zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzkn zzaD(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkn)) ? new C1423zza(iBinder) : (zzkn) queryLocalInterface;
        }
