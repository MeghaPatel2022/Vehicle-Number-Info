...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IProjectionDelegate {
        ...
        private static class C1489zza implements IProjectionDelegate {
            private IBinder zznI;

            C1489zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
            ...
            public VisibleRegion getVisibleRegion() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return obtain2.readInt() != 0 ? VisibleRegion.CREATOR.zzfl(obtain2) : null;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static IProjectionDelegate zzcI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IProjectionDelegate)) ? new C1489zza(iBinder) : (IProjectionDelegate) queryLocalInterface;
        }
