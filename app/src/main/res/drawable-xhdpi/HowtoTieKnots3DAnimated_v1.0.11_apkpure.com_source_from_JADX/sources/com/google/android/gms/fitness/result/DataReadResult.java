...
public class DataReadResult implements Result, SafeParcelable {
    ...
    public String toString() {
        return zzw.zzu(this).zzg("status", this.zzQA).zzg("dataSets", this.zzany.size() > 5 ? this.zzany.size() + " data sets" : this.zzany).zzg("buckets", this.zzaqG.size() > 5 ? this.zzaqG.size() + " buckets" : this.zzaqG).toString();
    }
    ...
    /* access modifiers changed from: 0000 */
    public List<RawBucket> zzsC() {
        ArrayList arrayList = new ArrayList(this.zzaqG.size());
    ...
    /* access modifiers changed from: 0000 */
    public List<RawDataSet> zzsD() {
        ArrayList arrayList = new ArrayList(this.zzany.size());
