...
public interface zzjp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjp {
        ...
        private static class C1417zza implements zzjp {
            private IBinder zznI;

            C1417zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
            ...
            public void zza(zzjo zzjo) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateService");
                    obtain.writeStrongBinder(zzjo != null ? zzjo.asBinder() : null);
            ...
            public void zza(zzjo zzjo, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateService");
            ...
            public void zza(zzjo zzjo, int i, String str, byte[] bArr) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateService");
            ...
            public void zza(zzjo zzjo, int i, byte[] bArr) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateService");
            ...
            public void zzb(zzjo zzjo) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateService");
            ...
            public void zzb(zzjo zzjo, int i) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateService");
            ...
            public void zzc(zzjo zzjo) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.appstate.internal.IAppStateService");
        ...
        public static zzjp zzan(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjp)) ? new C1417zza(iBinder) : (zzjp) queryLocalInterface;
        }
    ...
    void zza(zzjo zzjo, int i) throws RemoteException;

    void zza(zzjo zzjo, int i, String str, byte[] bArr) throws RemoteException;

    void zza(zzjo zzjo, int i, byte[] bArr) throws RemoteException;

    void zzb(zzjo zzjo) throws RemoteException;

    void zzb(zzjo zzjo, int i) throws RemoteException;

    void zzc(zzjo zzjo) throws RemoteException;
