...
public class zzy {
    ...
    public void setAdListener(AdListener adListener) {
        try {
            ...
            if (this.zztm != null) {
                this.zztm.zza((zzn) adListener != null ? new zzc(adListener) : null);
            }
        } catch (RemoteException e) {
    ...
    public void setAppEventListener(AppEventListener appEventListener) {
        try {
            ...
            if (this.zztm != null) {
                this.zztm.zza((zzt) appEventListener != null ? new zzi(appEventListener) : null);
            }
        } catch (RemoteException e) {
    ...
    public void setInAppPurchaseListener(InAppPurchaseListener inAppPurchaseListener) {
        ...
        try {
            ...
            if (this.zztm != null) {
                this.zztm.zza((zzfm) inAppPurchaseListener != null ? new zzfr(inAppPurchaseListener) : null);
            }
        } catch (RemoteException e) {
    ...
    public void setOnCustomRenderedAdLoadedListener(OnCustomRenderedAdLoadedListener onCustomRenderedAdLoadedListener) {
        ...
        try {
            if (this.zztm != null) {
                this.zztm.zza((zzch) onCustomRenderedAdLoadedListener != null ? new zzci(onCustomRenderedAdLoadedListener) : null);
            }
        } catch (RemoteException e) {
    ...
    public void zza(zza zza) {
        try {
            this.zzsn = zza;
            if (this.zztm != null) {
                this.zztm.zza((zzm) zza != null ? new zzb(zza) : null);
            }
        } catch (RemoteException e) {
    ...
    public void zzcS() throws RemoteException {
        ...
        this.zztm = zzcT();
        if (this.zzso != null) {
            this.zztm.zza((zzn) new zzc(this.zzso));
        }
        if (this.zzsn != null) {
            this.zztm.zza((zzm) new zzb(this.zzsn));
        }
        if (this.zzsK != null) {
            this.zztm.zza((zzt) new zzi(this.zzsK));
        }
        if (this.zztp != null) {
            this.zztm.zza((zzfm) new zzfr(this.zztp));
        }
        if (this.zztq != null) {
            this.zztm.zza(new zzfv(this.zztq), this.zztn);
        }
        if (this.zztr != null) {
            this.zztm.zza((zzch) new zzci(this.zztr));
        }
        this.zztm.zza((zzu) zzk.zzcG());
        this.zztm.setManualImpressionsEnabled(this.zzoM);
        zzcR();
    }
