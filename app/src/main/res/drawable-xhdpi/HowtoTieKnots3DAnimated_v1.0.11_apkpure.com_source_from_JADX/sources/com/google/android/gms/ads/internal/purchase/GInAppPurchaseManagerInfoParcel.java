...
public final class GInAppPurchaseManagerInfoParcel implements SafeParcelable {
    ...
    GInAppPurchaseManagerInfoParcel(int versionCode2, IBinder wrappedInAppPurchaseVerifier, IBinder wrappedInAppPurchase, IBinder wrappedAppContext, IBinder wrappedOnPlayStorePurchaseFinishedListener) {
