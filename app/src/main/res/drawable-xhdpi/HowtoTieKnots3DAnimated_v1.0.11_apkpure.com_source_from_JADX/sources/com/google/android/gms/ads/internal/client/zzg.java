...
public class zzg {
    ...
    public AdRequestParcel zza(Context context, zzx zzx) {
        ...
        return new AdRequestParcel(6, j, networkExtrasBundle, gender, list, isTestDevice, zzcP, manualImpressionsEnabled, publisherProvidedId, searchAdRequestParcel, location, contentUrl, zzx.zzcO(), zzx.getCustomTargeting(), Collections.unmodifiableList(new ArrayList(zzx.zzcQ())), zzx.zzcL(), str);
    }
