...
public class zzv implements zzb {
    ...
    private void removeEntry(String key) {
        zza zza2 = (zza) this.zzax.get(key);
        if (zza2 != null) {
            this.zzay -= zza2.zzaB;
    ...
    private void zza(String str, zza zza2) {
        if (!this.zzax.containsKey(str)) {
            ...
            zza zza3 = (zza) this.zzax.get(str);
            this.zzay = (zza2.zzaB - zza3.zzaB) + this.zzay;
        }
    ...
    public synchronized com.google.android.gms.internal.zzb.zza zza(java.lang.String r9) {
        /*
            ...
            r1 = 0
            monitor-enter(r8)
            java.util.Map<java.lang.String, com.google.android.gms.internal.zzv$zza> r0 = r8.zzax     // Catch:{ all -> 0x006a }
    ...
    public synchronized void zza() {
        /*
            ...
            r0 = 0
            monitor-enter(r9)
            java.io.File r1 = r9.zzaz     // Catch:{ all -> 0x006c }
            boolean r1 = r1.exists()     // Catch:{ all -> 0x006c }
            if (r1 != 0) goto L_0x0025
            java.io.File r0 = r9.zzaz     // Catch:{ all -> 0x006c }
            ...
            r2 = 0
            java.io.File r3 = r9.zzaz     // Catch:{ all -> 0x006c }
        ...
        L_0x002f:
            ...
            java.lang.String r6 = r1.key     // Catch:{ IOException -> 0x0078 }
