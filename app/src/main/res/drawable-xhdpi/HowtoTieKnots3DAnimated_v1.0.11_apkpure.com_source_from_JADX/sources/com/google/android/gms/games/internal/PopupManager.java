...
public class PopupManager {
    ...
    private static final class PopupManagerHCMR1 extends PopupManager implements OnAttachStateChangeListener, OnGlobalLayoutListener {
        ...
        public void zzfP(int i) {
            this.zzaup = new PopupLocationInfo(i, null);
        }

        public void zzn(View view) {
            this.zzauo.zzud();
            if (this.zzaus != null) {
                View view2 = (View) this.zzaus.get();
            ...
            this.zzaus = null;
            Context context2 = this.zzauo.getContext();
    ...
    /* access modifiers changed from: protected */
    public void zzfP(int i) {
        this.zzaup = new PopupLocationInfo(i, new Binder());
    }
