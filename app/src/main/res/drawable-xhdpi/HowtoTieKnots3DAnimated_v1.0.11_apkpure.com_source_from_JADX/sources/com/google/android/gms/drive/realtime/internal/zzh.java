...
public interface zzh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzh {
        ...
        private static class C1368zza implements zzh {
            private IBinder zznI;

            C1368zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzh zzbb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzh)) ? new C1368zza(iBinder) : (zzh) queryLocalInterface;
        }
