...
public abstract class RoomConfig {
    ...
    public static final class Builder {
        ...
        private Builder(RoomUpdateListener updateListener) {
            ...
            this.zzayo = (RoomUpdateListener) zzx.zzb(updateListener, (Object) "Must provide a RoomUpdateListener");
        }
        ...
        public Builder setVariant(int variant) {
            zzx.zzb(variant == -1 || variant > 0, (Object) "Variant must be a positive integer or Room.ROOM_VARIANT_ANY");
            this.zzayd = variant;
            return this;
        }
    }
