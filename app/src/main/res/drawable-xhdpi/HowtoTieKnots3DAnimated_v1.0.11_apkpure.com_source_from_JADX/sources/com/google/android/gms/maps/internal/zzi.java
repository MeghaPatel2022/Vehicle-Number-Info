...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        private static class C1501zza implements zzi {
            private IBinder zznI;

            C1501zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzi zzcu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzi)) ? new C1501zza(iBinder) : (zzi) queryLocalInterface;
        }
