...
public class zzlf<K, V> {
    ...
    public final V get(K r5) {
        ...
        L_0x000a:
            monitor-enter(r4)
            java.util.LinkedHashMap<K, V> r0 = r4.zzaex     // Catch:{ all -> 0x002a }
            java.lang.Object r0 = r0.get(r5)     // Catch:{ all -> 0x002a }
            if (r0 == 0) goto L_0x001b
            int r1 = r4.zzaeC     // Catch:{ all -> 0x002a }
            int r1 = r1 + 1
            r4.zzaeC = r1     // Catch:{ all -> 0x002a }
            monitor-exit(r4)     // Catch:{ all -> 0x002a }
        L_0x001a:
            return r0
        L_0x001b:
            int r0 = r4.zzaeD     // Catch:{ all -> 0x002a }
            int r0 = r0 + 1
            r4.zzaeD = r0     // Catch:{ all -> 0x002a }
            monitor-exit(r4)     // Catch:{ all -> 0x002a }
        ...
        L_0x002d:
            monitor-enter(r4)
            int r0 = r4.zzaeA     // Catch:{ all -> 0x0053 }
            int r0 = r0 + 1
            r4.zzaeA = r0     // Catch:{ all -> 0x0053 }
            java.util.LinkedHashMap<K, V> r0 = r4.zzaex     // Catch:{ all -> 0x0053 }
            java.lang.Object r0 = r0.put(r5, r1)     // Catch:{ all -> 0x0053 }
            if (r0 == 0) goto L_0x0049
            java.util.LinkedHashMap<K, V> r2 = r4.zzaex     // Catch:{ all -> 0x0053 }
        ...
        L_0x0056:
            ...
            goto L_0x001a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzlf.get(java.lang.Object):java.lang.Object");
    }
    ...
    public void trimToSize(int r5) {
        ...
        L_0x0000:
            ...
            java.util.LinkedHashMap<K, V> r0 = r4.zzaex     // Catch:{ all -> 0x0032 }
