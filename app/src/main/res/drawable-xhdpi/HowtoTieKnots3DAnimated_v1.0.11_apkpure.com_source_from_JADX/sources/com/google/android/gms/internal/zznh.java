...
public interface zznh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznh {
        ...
        private static class C1445zza implements zznh {
            private IBinder zznI;

            C1445zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zznh zzbJ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznh)) ? new C1445zza(iBinder) : (zznh) queryLocalInterface;
        }
