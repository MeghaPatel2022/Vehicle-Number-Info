...
import com.google.android.gms.ads.internal.reward.client.zza.C1334zza;
...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class C1338zza implements zzd {
            private IBinder zznI;

            C1338zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzd zzab(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzd)) ? new C1338zza(iBinder) : (zzd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAdListener");
                    zza(C1334zza.zzY(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAdListener");
