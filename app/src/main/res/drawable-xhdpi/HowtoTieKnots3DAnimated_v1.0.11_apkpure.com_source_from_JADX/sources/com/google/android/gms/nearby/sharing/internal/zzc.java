...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class C1533zza implements zzc {
            private IBinder zznI;

            C1533zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzc zzdn(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzc)) ? new C1533zza(iBinder) : (zzc) queryLocalInterface;
        }
