...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        private static class C1491zza implements IStreetViewPanoramaFragmentDelegate {
            private IBinder zznI;

            C1491zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
            ...
            public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
                ...
                try {
                    ...
                    return com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate.zza.zzcK(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static IStreetViewPanoramaFragmentDelegate zzcL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaFragmentDelegate)) ? new C1491zza(iBinder) : (IStreetViewPanoramaFragmentDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onInflate(com.google.android.gms.dynamic.zzd.zza.zzbk(data.readStrongBinder()), data.readInt() != 0 ? StreetViewPanoramaOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
