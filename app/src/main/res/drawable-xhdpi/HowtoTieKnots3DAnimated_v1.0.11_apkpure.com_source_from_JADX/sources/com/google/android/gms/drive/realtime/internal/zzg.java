...
public interface zzg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzg {
        ...
        private static class C1367zza implements zzg {
            private IBinder zznI;

            C1367zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzg zzba(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzg)) ? new C1367zza(iBinder) : (zzg) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(data.readInt() != 0 ? DataHolder.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (ParcelableEventList) ParcelableEventList.CREATOR.createFromParcel(data) : null);
