...
public final class DataType implements SafeParcelable {
    ...
    public static final DataType zzanN = new DataType("com.google.floor_change", Field.FIELD_ACTIVITY, Field.FIELD_CONFIDENCE, Field.zzaog, Field.zzaoj);
    public static final DataType zzanO = new DataType("com.google.activity.edge", Field.FIELD_ACTIVITY, Field.zzaom);
    public static final DataType zzanP = new DataType("com.google.accelerometer", Field.zzaon, Field.zzaoo, Field.zzaop);
    public static final DataType zzanQ = new DataType("com.google.body.waist.circumference", Field.FIELD_CIRCUMFERENCE);
    public static final DataType zzanR = new DataType("com.google.body.hip.circumference", Field.FIELD_CIRCUMFERENCE);
    public static final DataType zzanS = new DataType("com.google.floor_change.summary", Field.zzaoe, Field.zzaof, Field.zzaoh, Field.zzaoi, Field.zzaok, Field.zzaol);
    public static final DataType zzanT = new DataType("com.google.body.hip.circumference.summary", Field.FIELD_AVERAGE, Field.FIELD_MAX, Field.FIELD_MIN);
    public static final DataType zzanU = new DataType("com.google.body.waist.circumference.summary", Field.FIELD_AVERAGE, Field.FIELD_MAX, Field.FIELD_MIN);
    private static final Map<DataType, List<DataType>> zzanV = new HashMap<DataType, List<DataType>>() {
        {
