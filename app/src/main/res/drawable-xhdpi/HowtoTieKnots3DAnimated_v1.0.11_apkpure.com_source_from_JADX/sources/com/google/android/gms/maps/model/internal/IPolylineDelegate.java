...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IPolylineDelegate {
        ...
        private static class C1516zza implements IPolylineDelegate {
            private IBinder zznI;

            C1516zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static IPolylineDelegate zzcV(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPolylineDelegate)) ? new C1516zza(iBinder) : (IPolylineDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    boolean equalsRemote = equalsRemote(zzcV(data.readStrongBinder()));
                    reply.writeNoException();
                    if (equalsRemote) {
                        z = true;
                    }
