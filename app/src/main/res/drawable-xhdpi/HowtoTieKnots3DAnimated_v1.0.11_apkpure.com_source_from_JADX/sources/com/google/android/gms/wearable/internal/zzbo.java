...
final class zzbo<T> extends zza {
    ...
    private zzbo(C1552zza zza, zzc.zza zza2, DataListener dataListener, MessageListener messageListener, NodeListener nodeListener, NodeApi.zza zza3, ChannelListener channelListener, CapabilityListener capabilityListener, IntentFilter[] intentFilterArr, String str, String str2) {
        this.zzbbg = zza;
        this.zzbbh = zza2;
