...
public interface zzjd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjd {
        ...
        private static class C1413zza implements zzjd {
            private IBinder zznI;

            C1413zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzjd zzag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjd)) ? new C1413zza(iBinder) : (zzjd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearchCallbacks");
                    if (data.readInt() != 0) {
                        response = Response.CREATOR.createFromParcel(data);
                    }
                    zza(response);
                    return true;
                case 1598968902:
