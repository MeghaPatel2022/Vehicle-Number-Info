...
class zzw implements zzc {
    ...
    public static final String zzaPJ = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' STRING NOT NULL, '%s' BLOB NOT NULL, '%s' INTEGER NOT NULL);", new Object[]{"datalayer", "ID", "key", "value", "expires"});
    /* access modifiers changed from: private */
    ...
    zzw(Context context, zzlm zzlm, String str, int i, Executor executor) {
        this.mContext = context;
        this.zzpO = zzlm;
        this.zzaPM = i;
        this.zzaPK = executor;
        this.zzaPL = new zza(this.mContext, str);
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private byte[] zzC(java.lang.Object r6) {
        /*
            r5 = this;
            r0 = 0
        ...
        L_0x003b:
            ...
            goto L_0x001a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.zzw.zzC(java.lang.Object):byte[]");
    }
    ...
    private void zzS(long j) {
        ...
        if (zzeG != null) {
            try {
                zzbg.m29v("Deleted " + zzeG.delete("datalayer", "expires <= ?", new String[]{Long.toString(j)}) + " expired items");
            } catch (SQLiteException e) {
    ...
    private void zzc(List<zzb> list, long j) {
        ...
        if (zzeG != null) {
            for (zzb zzb2 : list) {
                ...
                contentValues.put("key", zzb2.zztP);
                contentValues.put("value", zzb2.zzaPS);
    ...
    public void zzeF(String str) {
        ...
        if (zzeG != null) {
            try {
                zzbg.m29v("Cleared " + zzeG.delete("datalayer", "key = ? OR key LIKE ?", new String[]{str, str + ".%"}) + " items");
            } catch (SQLiteException e) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.List<java.lang.String> zzje(int r14) {
        /*
            r13 = this;
            r10 = 0
        ...
        L_0x0088:
            ...
            goto L_0x005e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.zzw.zzje(int):java.util.List");
    }

    private List<zza> zzp(List<zzb> list) {
        ArrayList arrayList = new ArrayList();
        for (zzb zzb2 : list) {
            arrayList.add(new zza(zzb2.zztP, zzq(zzb2.zzaPS)));
        }
        return arrayList;
    }
    ...
    private List<zzb> zzq(List<zza> list) {
        ArrayList arrayList = new ArrayList();
        for (zza zza2 : list) {
            arrayList.add(new zzb(zza2.zztP, zzC(zza2.zzID)));
        }
        return arrayList;
    }

    /* access modifiers changed from: private */
    public List<zza> zzzS() {
        try {
    ...
    private int zzzU() {
        ...
        if (zzeG != null) {
            try {
                Cursor rawQuery = zzeG.rawQuery("SELECT COUNT(*) from datalayer", null);
    ...
    public void zza(final com.google.android.gms.tagmanager.DataLayer.zzc.zza zza2) {
        this.zzaPK.execute(new Runnable() {
            public void run() {
                zza2.zzo(zzw.this.zzzS());
            }
        });
    }

    public void zza(List<zza> list, final long j) {
        final List zzq = zzq(list);
        this.zzaPK.execute(new Runnable() {
            public void run() {
                zzw.this.zzb(zzq, j);
            }
    ...
    public void zzeE(final String str) {
        this.zzaPK.execute(new Runnable() {
            public void run() {
                zzw.this.zzeF(str);
            }
