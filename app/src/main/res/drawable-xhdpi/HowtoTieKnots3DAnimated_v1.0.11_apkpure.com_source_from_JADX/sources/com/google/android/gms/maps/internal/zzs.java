...
public interface zzs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzs {
        ...
        private static class C1511zza implements zzs {
            private IBinder zznI;

            C1511zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzs zzcE(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzs)) ? new C1511zza(iBinder) : (zzs) queryLocalInterface;
        }
