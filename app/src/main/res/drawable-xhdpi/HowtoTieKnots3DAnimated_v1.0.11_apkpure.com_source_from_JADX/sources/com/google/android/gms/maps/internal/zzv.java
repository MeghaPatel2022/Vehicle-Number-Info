...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        private static class C1514zza implements zzv {
            private IBinder zznI;

            C1514zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzv zzcH(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C1514zza(iBinder) : (zzv) queryLocalInterface;
        }
