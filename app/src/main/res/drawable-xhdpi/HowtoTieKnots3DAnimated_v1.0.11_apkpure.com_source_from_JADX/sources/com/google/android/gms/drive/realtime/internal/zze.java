...
public interface zze extends IInterface {
    ...
    public static abstract class zza extends Binder implements zze {
        ...
        private static class C1365zza implements zze {
            private IBinder zznI;

            C1365zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zze zzaY(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zze)) ? new C1365zza(iBinder) : (zze) queryLocalInterface;
        }
