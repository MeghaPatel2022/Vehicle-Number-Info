...
public class DataBufferAdapter<T> extends BaseAdapter {
    ...
    private View zza(int i, View view, ViewGroup viewGroup, int i2) {
        View view2 = view == null ? this.mInflater.inflate(i2, viewGroup, false) : view;
        try {
            TextView textView = this.zzamK == 0 ? (TextView) view2 : (TextView) view2.findViewById(this.zzamK);
