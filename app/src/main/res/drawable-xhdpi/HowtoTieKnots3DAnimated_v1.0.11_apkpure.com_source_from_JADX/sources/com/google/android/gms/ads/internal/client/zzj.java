...
public final class zzj {
    ...
    public zzj(Context context, AttributeSet attributeSet) {
        boolean z = true;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0224R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C0224R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C0224R.styleable.AdsAttrs_adSizes);
        ...
        this.zzoZ = obtainAttributes.getString(C0224R.styleable.AdsAttrs_adUnitId);
