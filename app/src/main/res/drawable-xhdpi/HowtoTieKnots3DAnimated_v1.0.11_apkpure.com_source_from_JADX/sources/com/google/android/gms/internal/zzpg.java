...
public interface zzpg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpg {
        ...
        /* renamed from: com.google.android.gms.internal.zzpg$zza$zza reason: collision with other inner class name */
        private static class C1458zza implements zzpg {
            private IBinder zznI;

            C1458zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzpg zzdq(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzpg)) ? new C1458zza(iBinder) : (zzpg) queryLocalInterface;
        }
