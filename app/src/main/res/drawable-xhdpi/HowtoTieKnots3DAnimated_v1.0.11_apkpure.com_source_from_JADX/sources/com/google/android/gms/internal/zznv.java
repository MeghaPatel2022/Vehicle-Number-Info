...
public interface zznv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznv {
        ...
        private static class C1447zza implements zznv {
            private IBinder zznI;

            C1447zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zznv zzbL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznv)) ? new C1447zza(iBinder) : (zznv) queryLocalInterface;
        }
