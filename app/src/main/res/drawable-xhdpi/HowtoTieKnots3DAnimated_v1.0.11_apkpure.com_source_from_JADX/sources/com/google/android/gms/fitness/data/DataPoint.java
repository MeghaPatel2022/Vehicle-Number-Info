...
public final class DataPoint implements SafeParcelable {
    ...
    private DataPoint(DataSource dataSource) {
        this.mVersionCode = 4;
        this.zzanm = (DataSource) zzx.zzb(dataSource, (Object) "Data source cannot be null");
        ...
        while (true) {
            int i2 = i;
            if (it.hasNext()) {
                this.zzanD[i2] = new Value(((Field) it.next()).getFormat());
                i = i2 + 1;
            } else {
                return;
            }
    ...
    DataPoint(List<DataSource> dataSources, RawDataPoint rawDataPoint) {
        this(zza(dataSources, rawDataPoint.zzaow), zza(dataSources, rawDataPoint.zzaox), rawDataPoint);
    }
