...
public interface zznc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznc {
        ...
        private static class C1440zza implements zznc {
            private IBinder zznI;

            C1440zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zznc zzbE(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznc)) ? new C1440zza(iBinder) : (zznc) queryLocalInterface;
        }
