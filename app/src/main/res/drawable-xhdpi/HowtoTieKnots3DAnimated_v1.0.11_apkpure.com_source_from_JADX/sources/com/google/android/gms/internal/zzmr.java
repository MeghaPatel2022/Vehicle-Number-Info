...
public interface zzmr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmr {
        ...
        private static class C1429zza implements zzmr {
            private IBinder zznI;

            C1429zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzmr zzbt(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmr)) ? new C1429zza(iBinder) : (zzmr) queryLocalInterface;
        }
