...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class C1521zza implements zzd {
            private IBinder zznI;

            C1521zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzd zzcR(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzd)) ? new C1521zza(iBinder) : (zzd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    boolean zzb = zzb(zzcR(data.readStrongBinder()));
                    reply.writeNoException();
                    if (zzb) {
                        i = 1;
                    }
