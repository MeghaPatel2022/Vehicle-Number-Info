...
class zzby implements zzau {
    ...
    public static final String zzMg = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL,'%s' INTEGER NOT NULL);", new Object[]{"gtm_hits", "hit_id", "hit_time", "hit_url", "hit_first_send_time"});
    /* access modifiers changed from: private */
    ...
    class zza implements com.google.android.gms.tagmanager.zzcx.zza {
        ...
        public void zza(zzaq zzaq) {
            zzby.this.zzq(zzaq.zzAe());
        }

        public void zzb(zzaq zzaq) {
            zzby.this.zzq(zzaq.zzAe());
            zzbg.m29v("Permanent failure dispatching hitId: " + zzaq.zzAe());
        }

        public void zzc(zzaq zzaq) {
            long zzAf = zzaq.zzAf();
            if (zzAf == 0) {
                zzby.this.zzc(zzaq.zzAe(), zzby.this.zzpO.currentTimeMillis());
            } else if (zzAf + 14400000 < zzby.this.zzpO.currentTimeMillis()) {
                zzby.this.zzq(zzaq.zzAe());
                zzbg.m29v("Giving up on failed hitId: " + zzaq.zzAe());
            }
        }
    }
    ...
    class zzb extends SQLiteOpenHelper {
        ...
        private boolean zza(java.lang.String r11, android.database.sqlite.SQLiteDatabase r12) {
            ...
            L_0x0028:
                ...
                com.google.android.gms.tagmanager.zzbg.zzaE(r1)     // Catch:{ all -> 0x004f }
        ...
        public SQLiteDatabase getWritableDatabase() {
            if (!this.zzaQT || this.zzaQU + 3600000 <= zzby.this.zzpO.currentTimeMillis()) {
    ...
    zzby(zzav zzav, Context context, String str, int i) {
        ...
        this.zzaQN = new zzcx(new DefaultHttpClient(), this.mContext, new zza());
        this.zzaQQ = 0;
        this.zzaQR = i;
    }
    ...
    private void zzAr() {
        ...
        if (zzAs > 0) {
            List zzjj = zzjj(zzAs);
            zzbg.m29v("Store full, deleting " + zzjj.size() + " hits to make room.");
    ...
    public void dispatch() {
        zzbg.m29v("GTM Dispatch running...");
        if (this.zzaQN.zzzX()) {
            List zzjk = zzjk(40);
            if (zzjk.isEmpty()) {
                zzbg.m29v("...nothing to dispatch");
    ...
    public int zzAs() {
        ...
        if (zzeG != null) {
            try {
                Cursor rawQuery = zzeG.rawQuery("SELECT COUNT(*) from gtm_hits", null);
    ...
    public int zzAt() {
        /*
            ...
            android.database.sqlite.SQLiteDatabase r0 = r10.zzeG(r0)
        ...
        L_0x0031:
            ...
            com.google.android.gms.tagmanager.zzbg.zzaE(r1)     // Catch:{ all -> 0x0047 }
        ...
        L_0x004e:
            ...
            goto L_0x002d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.zzby.zzAt():int");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.util.List<java.lang.String> zzjj(int r14) {
        /*
            r13 = this;
            r10 = 0
        ...
        L_0x000f:
            ...
            android.database.sqlite.SQLiteDatabase r0 = r13.zzeG(r0)
        ...
        L_0x005e:
            ...
            com.google.android.gms.tagmanager.zzbg.zzaE(r0)     // Catch:{ all -> 0x0086 }
            if (r1 == 0) goto L_0x005a
            r1.close()
            goto L_0x005a
        L_0x007e:
        ...
        L_0x0088:
            ...
            goto L_0x005e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.zzby.zzjj(int):java.util.List");
    }
    ...
    public java.util.List<com.google.android.gms.tagmanager.zzaq> zzjk(int r17) {
        /*
            ...
            r0 = r16
            android.database.sqlite.SQLiteDatabase r2 = r0.zzeG(r2)
        ...
        L_0x00f6:
            ...
            java.lang.Object r2 = r12.get(r4)     // Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
            com.google.android.gms.tagmanager.zzaq r2 = (com.google.android.gms.tagmanager.zzaq) r2     // Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
            long r8 = r2.zzAe()     // Catch:{ SQLiteException -> 0x0114, all -> 0x0166 }
        ...
        L_0x013a:
            ...
            java.lang.String r6 = r2.zzAg()     // Catch:{ all -> 0x015f }
        ...
        L_0x017d:
            ...
            goto L_0x009e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.zzby.zzjk(int):java.util.List");
    }
}
