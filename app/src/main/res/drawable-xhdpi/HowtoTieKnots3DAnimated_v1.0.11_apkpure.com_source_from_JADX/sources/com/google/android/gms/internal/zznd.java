...
public interface zznd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznd {
        ...
        /* renamed from: com.google.android.gms.internal.zznd$zza$zza reason: collision with other inner class name */
        private static class C1441zza implements zznd {
            private IBinder zznI;

            C1441zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zznd zzbF(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zznd)) ? new C1441zza(iBinder) : (zznd) queryLocalInterface;
        }
