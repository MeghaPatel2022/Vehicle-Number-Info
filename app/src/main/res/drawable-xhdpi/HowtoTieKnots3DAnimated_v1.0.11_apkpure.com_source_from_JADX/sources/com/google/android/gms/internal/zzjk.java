...
public interface zzjk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjk {
        ...
        private static class C1414zza implements zzjk {
            private IBinder zznI;

            C1414zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzjk zzaj(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzjk)) ? new C1414zza(iBinder) : (zzjk) queryLocalInterface;
        }
