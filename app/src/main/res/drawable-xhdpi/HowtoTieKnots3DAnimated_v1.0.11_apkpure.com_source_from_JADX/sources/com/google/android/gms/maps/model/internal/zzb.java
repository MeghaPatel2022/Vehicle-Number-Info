...
public interface zzb extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzb {
        ...
        private static class C1519zza implements zzb {
            private IBinder zznI;

            C1519zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzb zzcP(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzb)) ? new C1519zza(iBinder) : (zzb) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 17:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    boolean zza = zza(zzcP(data.readStrongBinder()));
                    reply.writeNoException();
                    if (zza) {
                        z = true;
                    }
