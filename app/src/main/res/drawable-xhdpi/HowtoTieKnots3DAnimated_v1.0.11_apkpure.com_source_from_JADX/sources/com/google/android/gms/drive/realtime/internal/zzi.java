...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        private static class C1369zza implements zzi {
            private IBinder zznI;

            C1369zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzi zzbc(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzi)) ? new C1369zza(iBinder) : (zzi) queryLocalInterface;
        }
