...
public interface zzl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzl {
        ...
        private static class C1372zza implements zzl {
            private IBinder zznI;

            C1372zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzl zzbf(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzl)) ? new C1372zza(iBinder) : (zzl) queryLocalInterface;
        }
