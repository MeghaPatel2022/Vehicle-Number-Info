...
public interface zzoy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzoy {
        ...
        /* renamed from: com.google.android.gms.internal.zzoy$zza$zza reason: collision with other inner class name */
        private static class C1453zza implements zzoy {
            private IBinder zznI;

            C1453zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzoy zzdb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzoy)) ? new C1453zza(iBinder) : (zzoy) queryLocalInterface;
        }
