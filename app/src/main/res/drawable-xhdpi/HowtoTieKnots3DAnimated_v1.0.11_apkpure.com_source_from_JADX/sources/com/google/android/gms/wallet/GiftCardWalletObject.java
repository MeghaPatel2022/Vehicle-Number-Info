...
public final class GiftCardWalletObject implements SafeParcelable {
    ...
    GiftCardWalletObject(int versionCode, CommonWalletObject commonWalletObject, String cardNumber, String pin2, String cardIdentifier, long balanceMicros, String balanceCurrencyCode, long balanceUpdateTime, String eventNumber) {
        this.zzaWv = CommonWalletObject.zzCn().zzCo();
