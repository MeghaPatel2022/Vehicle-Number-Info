...
public interface zzh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzh {
        ...
        private static class C1525zza implements zzh {
            private IBinder zznI;

            C1525zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzh zzcW(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzh)) ? new C1525zza(iBinder) : (zzh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    boolean zza = zza(zzcW(data.readStrongBinder()));
                    reply.writeNoException();
                    if (zza) {
                        z = true;
                    }
