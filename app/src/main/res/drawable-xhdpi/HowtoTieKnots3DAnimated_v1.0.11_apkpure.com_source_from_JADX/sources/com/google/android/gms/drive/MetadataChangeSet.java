...
public final class MetadataChangeSet {
    ...
    public static class Builder {
        ...
        public Builder setIndexableText(String text) {
            zzk("Indexable text size", 131072, zzcE(text));
    ...
    public Map<CustomPropertyKey, String> getCustomPropertyChangeMap() {
        AppVisibleCustomProperties appVisibleCustomProperties = (AppVisibleCustomProperties) this.zzagS.zza((MetadataField<T>) zzmb.zzakq);
    ...
    public Date getLastViewedByMeDate() {
        return (Date) this.zzagS.zza((MetadataField<T>) zzmd.zzale);
    }

    public String getMimeType() {
        return (String) this.zzagS.zza((MetadataField<T>) zzmb.zzakL);
    }

    public String getTitle() {
        return (String) this.zzagS.zza((MetadataField<T>) zzmb.zzakU);
    }

    public Boolean isPinned() {
        return (Boolean) this.zzagS.zza((MetadataField<T>) zzmb.zzakD);
    }

    public Boolean isStarred() {
        return (Boolean) this.zzagS.zza((MetadataField<T>) zzmb.zzakS);
    }
