...
public interface GoogleApiClient {
    ...
    public static final class Builder {
        ...
        /* access modifiers changed from: private */
        public void zza(zzp zzp, GoogleApiClient googleApiClient) {
            zzp.zza(this.zzZf, googleApiClient, this.zzZh);
        }

        private GoogleApiClient zznj() {
            final zzi zzi = new zzi(this.mContext.getApplicationContext(), this.zzYV, zzni(), this.zzZi, this.zzZj, this.zzZd, this.zzZk, this.zzZl, this.zzZf, -1);
                ...
                new Handler(this.mContext.getMainLooper()).post(new Runnable() {
                    public void run() {
                        if (!Builder.this.zzZe.isFinishing() && !Builder.this.zzZe.getSupportFragmentManager().isDestroyed()) {
                            Builder.this.zza(zzp.zzb(Builder.this.zzZe), zzi);
                        }
                    }
                });
            } else {
        ...
        public Builder enableAutoManage(FragmentActivity fragmentActivity, int clientId, OnConnectionFailedListener unresolvedConnectionFailedListener) {
            ...
            this.zzZf = clientId;
            this.zzZe = (FragmentActivity) zzx.zzb(fragmentActivity, (Object) "Null activity is not permitted.");
    ...
    <C extends Api.zzb> C zza(zzc<C> zzc);
