package com.google.android.gms.location.places.p004ui;
...
public class PlacePicker {
    ...
    public static LatLngBounds getLatLngBounds(Intent intent) {
        return (LatLngBounds) zzc.zza(intent, "final_latlng_bounds", (Creator<T>) LatLngBounds.CREATOR);
    }

    public static Place getPlace(Intent intent, Context context) {
        zzx.zzb(context, (Object) "context must not be null");
        PlaceImpl placeImpl = (PlaceImpl) zzc.zza(intent, "selected_place", (Creator<T>) PlaceImpl.CREATOR);
