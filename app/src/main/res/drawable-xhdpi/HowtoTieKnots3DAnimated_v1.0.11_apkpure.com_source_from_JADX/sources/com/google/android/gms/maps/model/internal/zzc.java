...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class C1520zza implements zzc {
            private IBinder zznI;

            C1520zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
            ...
            public boolean zza(zzc zzc) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
        ...
        public static zzc zzcQ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzc)) ? new C1520zza(iBinder) : (zzc) queryLocalInterface;
        }
    ...
    boolean zza(zzc zzc) throws RemoteException;
