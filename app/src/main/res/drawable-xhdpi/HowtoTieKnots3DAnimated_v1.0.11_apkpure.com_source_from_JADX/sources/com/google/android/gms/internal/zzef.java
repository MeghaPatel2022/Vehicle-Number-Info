    ...
    public void zza(Context context, String str, zzhj zzhj, String str2, boolean z, List<String> list) {
        if (list != null && !list.isEmpty()) {
            ...
            for (String replaceAll : list) {
                String replaceAll2 = replaceAll.replaceAll("@gw_adlocid@", str2).replaceAll("@gw_adnetrefresh@", str3).replaceAll("@gw_qdata@", zzhj.zzGG.zzyz).replaceAll("@gw_sdkver@", str).replaceAll("@gw_sessid@", zzp.zzbA().getSessionId()).replaceAll("@gw_seqnum@", zzhj.zzDB);
                if (zzhj.zzyQ != null) {
