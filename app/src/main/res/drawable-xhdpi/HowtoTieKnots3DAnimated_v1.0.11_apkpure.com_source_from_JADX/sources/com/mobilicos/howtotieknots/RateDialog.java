...
public class RateDialog implements OnClickListener {
    ...
    String androidUri = "market://details?id=com.mobilicos.howtotieknots";
    Builder builder;
    Context context;
    ...
    String title = "Rate How to Tie Knots";
    ...
    public RateDialog(Context context2) {
        ...
        this.androidButton = (ImageButton) view.findViewById(C1295R.C1297id.android_logo);
        this.facebookButton = (ImageButton) view.findViewById(C1295R.C1297id.facebook_logo);
        this.twitterButton = (ImageButton) view.findViewById(C1295R.C1297id.twitter_logo);
