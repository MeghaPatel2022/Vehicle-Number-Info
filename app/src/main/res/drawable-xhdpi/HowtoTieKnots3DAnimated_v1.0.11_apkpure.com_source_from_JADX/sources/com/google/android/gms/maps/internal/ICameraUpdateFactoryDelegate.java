...
public interface ICameraUpdateFactoryDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements ICameraUpdateFactoryDelegate {
        ...
        private static class C1484zza implements ICameraUpdateFactoryDelegate {
            private IBinder zznI;

            C1484zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static ICameraUpdateFactoryDelegate zzci(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ICameraUpdateFactoryDelegate)) ? new C1484zza(iBinder) : (ICameraUpdateFactoryDelegate) queryLocalInterface;
        }
