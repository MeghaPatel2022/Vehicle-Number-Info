...
public class zzh {
    ...
    public zzh(Context context, zzn zzn, zzbb zzbb, zzan zzan, JSONObject jSONObject, zza zza2, VersionInfoParcel versionInfoParcel) {
    ...
    public zzip zzdy() {
        ...
        this.zzwf.zza("/loadHtml", (zzdg) new zzdg() {
            public void zza(zzip zzip, final Map<String, String> map) {
                zzh.this.zzoL.zzgS().zza((com.google.android.gms.internal.zziq.zza) new com.google.android.gms.internal.zziq.zza() {
                ...
                zzh.this.zzoL.loadData((String) map.get("overlayHtml"), "text/html", "UTF-8");
            }
        });
        ...
        this.zzoL.zzgS().zza("/hideOverlay", (zzdg) new zzdg() {
            public void zza(zzip zzip, Map<String, String> map) {
                zzh.this.zzoL.getWebView().setVisibility(8);
            }
        });
        this.zzoL.zzgS().zza("/sendMessageToSdk", (zzdg) new zzdg() {
            public void zza(zzip zzip, Map<String, String> map) {
                JSONObject jSONObject = new JSONObject();
                try {
