...
public interface zzw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzw {
        ...
        private static class C1515zza implements zzw {
            private IBinder zznI;

            C1515zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzw zzcJ(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzw)) ? new C1515zza(iBinder) : (zzw) queryLocalInterface;
        }
