...
public class zzu {
    ...
    public synchronized byte[] zzb(int r5) {
        /*
            ...
            r1 = r0
        L_0x0003:
            java.util.List<byte[]> r0 = r4.zzat     // Catch:{ all -> 0x002f }
            ...
            int r2 = r4.zzau     // Catch:{ all -> 0x002f }
            int r3 = r0.length     // Catch:{ all -> 0x002f }
            int r2 = r2 - r3
            r4.zzau = r2     // Catch:{ all -> 0x002f }
            java.util.List<byte[]> r2 = r4.zzat     // Catch:{ all -> 0x002f }
            r2.remove(r1)     // Catch:{ all -> 0x002f }
            java.util.List<byte[]> r1 = r4.zzas     // Catch:{ all -> 0x002f }
