...
public final class AdRequest {
    ...
    public static final class Builder {
        ...
        public Builder addCustomEventExtrasBundle(Class<? extends CustomEvent> adapterClass, Bundle customEventExtras) {
            this.zznO.zzb(adapterClass, customEventExtras);
            return this;
        }
        ...
        public Builder setContentUrl(String contentUrl) {
            com.google.android.gms.common.internal.zzx.zzb(contentUrl, (Object) "Content URL must be non-null.");
            com.google.android.gms.common.internal.zzx.zzh(contentUrl, "Content URL must be non-empty.");
            com.google.android.gms.common.internal.zzx.zzb(contentUrl.length() <= 512, "Content URL must not exceed %d in length.  Provided length was %d.", Integer.valueOf(512), Integer.valueOf(contentUrl.length()));
