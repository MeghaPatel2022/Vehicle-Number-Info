...
public final class TurnBasedMatchEntity implements SafeParcelable, TurnBasedMatch {
    ...
    public TurnBasedMatchEntity(TurnBasedMatch match) {
        ...
        if (previousMatchData == null) {
            ...
            this.zzayI = new byte[previousMatchData.length];
            System.arraycopy(previousMatchData, 0, this.zzayI, 0, previousMatchData.length);
        }
    ...
    public int getAvailableAutoMatchSlots() {
        ...
        return this.zzayt.getInt(Multiplayer.EXTRA_MAX_AUTOMATCH_PLAYERS);
    }
