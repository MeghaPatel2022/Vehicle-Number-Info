...
public interface zzau extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzau {
        ...
        private static class C1385zza implements zzau {
            private IBinder zznI;

            C1385zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzau zza(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzau)) ? new C1385zza(iBinder) : (zzau) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 3:
                    data.enforceInterface("com.google.android.auth.IAuthManagerService");
                    AccountChangeEventsResponse zza3 = zza(data.readInt() != 0 ? (AccountChangeEventsRequest) AccountChangeEventsRequest.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    if (zza3 != null) {
                        reply.writeInt(1);
