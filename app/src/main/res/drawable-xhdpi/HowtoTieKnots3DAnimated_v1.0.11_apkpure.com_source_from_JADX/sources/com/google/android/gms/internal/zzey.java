    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                zzL.setTitle(zzp.zzbA().zzc(C0224R.string.store_picture_title, "Save image"));
                zzL.setMessage(zzp.zzbA().zzc(C0224R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
