...
public interface zzmy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmy {
        ...
        private static class C1436zza implements zzmy {
            private IBinder zznI;

            C1436zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzmy zzbA(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzmy)) ? new C1436zza(iBinder) : (zzmy) queryLocalInterface;
        }
