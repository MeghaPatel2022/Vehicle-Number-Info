...
public class Query implements SafeParcelable {
    ...
    public static class Builder {
        ...
        private final List<Filter> zzalq = new ArrayList();
        ...
        public Query build() {
            return new Query(new LogicalFilter(Operator.zzalR, this.zzalq), this.zzalm, this.zzaln, (List) this.zzalo, this.zzalp, (Set) this.zzahr);
        }
