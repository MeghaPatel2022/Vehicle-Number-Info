...
public final class PlayerRef extends zzc implements Player {
    ...
    private boolean zzsU() {
        return !zzcf(this.zzarQ.zzaxa) && getLong(this.zzarQ.zzaxa) != -1;
    }
    ...
    public long getLastPlayedWithTimestamp() {
        if (!zzcd(this.zzarQ.zzawZ) || zzcf(this.zzarQ.zzawZ)) {
            return -1;
        }
        return getLong(this.zzarQ.zzawZ);
    }
