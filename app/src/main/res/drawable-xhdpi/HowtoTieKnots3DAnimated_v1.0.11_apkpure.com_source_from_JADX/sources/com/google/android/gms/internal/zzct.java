...
public interface zzct extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzct {
        ...
        private static class C1395zza implements zzct {
            private IBinder zznI;

            C1395zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzct zzz(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzct)) ? new C1395zza(iBinder) : (zzct) queryLocalInterface;
        }
