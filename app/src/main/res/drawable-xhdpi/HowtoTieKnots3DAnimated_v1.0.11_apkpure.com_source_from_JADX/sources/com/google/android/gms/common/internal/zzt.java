...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C1356zza implements zzt {
            private IBinder zznI;

            C1356zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzt zzaL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzt)) ? new C1356zza(iBinder) : (zzt) queryLocalInterface;
        }
