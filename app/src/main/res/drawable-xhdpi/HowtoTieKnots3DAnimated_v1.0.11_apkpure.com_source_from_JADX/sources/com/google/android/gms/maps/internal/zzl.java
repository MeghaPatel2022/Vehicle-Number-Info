...
public interface zzl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzl {
        ...
        private static class C1504zza implements zzl {
            private IBinder zznI;

            C1504zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzl zzcx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzl)) ? new C1504zza(iBinder) : (zzl) queryLocalInterface;
        }
