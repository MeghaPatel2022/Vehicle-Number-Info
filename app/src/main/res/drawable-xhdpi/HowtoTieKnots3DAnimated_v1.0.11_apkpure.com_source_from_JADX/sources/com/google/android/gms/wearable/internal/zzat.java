...
public interface zzat extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzat {
        ...
        private static class C1548zza implements zzat {
            private IBinder zznI;

            C1548zza(IBinder iBinder) {
                this.zznI = iBinder;
            }
        ...
        public static zzat zzdX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzat)) ? new C1548zza(iBinder) : (zzat) queryLocalInterface;
        }
