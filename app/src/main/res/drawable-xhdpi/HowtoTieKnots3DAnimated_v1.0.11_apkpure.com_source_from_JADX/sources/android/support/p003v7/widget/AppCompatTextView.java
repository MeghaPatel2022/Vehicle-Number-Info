...
public class AppCompatTextView extends TextView {
    ...
    public AppCompatTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0142R.styleable.AppCompatTextView, defStyle, 0);
        int ap = a.getResourceId(C0142R.styleable.AppCompatTextView_android_textAppearance, -1);
        a.recycle();
        if (ap != -1) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, C0142R.styleable.AppCompatTextView, defStyle, 0);
        if (a2.hasValue(C0142R.styleable.AppCompatTextView_textAllCaps)) {
            setAllCaps(a2.getBoolean(C0142R.styleable.AppCompatTextView_textAllCaps, false));
        }
        a2.recycle();
    }
