...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0142R.styleable.MenuView, defStyle, 0);
        this.mBackground = a.getDrawable(C0142R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0142R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0142R.styleable.MenuView_preserveIconSpacing, false);
    ...
    public void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0142R.C0144id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0142R.C0144id.shortcut);
    }
